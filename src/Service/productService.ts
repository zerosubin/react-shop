...
export const fashionfetchProducts = async () => {
  ...
  const reponse = await remote.get<ProductsListType, any>(fashionListUrl)
...
export const jeweleryfetchProducts = async () => {
  ...
  const reponse = await remote.get<ProductsListType, any>(jeweleryListUrl)
...
export const digitalfetchProducts = async () => {
  ...
  const reponse = await remote.get<ProductsListType, any>(digitalListUrl)
...
export const fashionListfetchProducts = async () => {
  ...
  const reponse = await remote.get<ProductsListType, any>(fashionAllListUrl)
...
export const electronicsListfetchProducts = async () => {
  ...
  const reponse = await remote.get<ProductsListType, any>(electronicsAllListURL)
